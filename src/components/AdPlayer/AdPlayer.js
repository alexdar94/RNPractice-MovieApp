...
export default class VideoPlayer extends Component {
  ...
  */
  ...
  /**
   * Default 'onVisitAdvertiser' function, prompt to add
   */
  _onVisitAdvertiser() {
    console.warn('Warning: Modify default _onVisitAdvertiser or pass function to onVisitAdvertiser prop');
  }
  ...
  */
   ...
   */
  renderSkipAd() {
    let mustWatchAdLength = this.props.mustWatchAdLength || 5;
    let mustWatchAdTimeLeft = Math.floor(mustWatchAdLength - this.state.currentTime);
    if (mustWatchAdTimeLeft < 1) {
      return (
        <Animated.View style={[
          ...
          <TouchableWithoutFeedback
            onPress={this.events.onEnd} style={styles.ad.adAlignRight}>
            <View style={styles.ad.container}>
              <Text style={styles.ad.skipAdText}>Skip ad</Text>
              <Image source={require('./assets/img/next.png')}
                     style={styles.ad.skipAdArrow}/>
            </View>
          </TouchableWithoutFeedback>
        </Animated.View>
      );
  ...
  renderVisitAdvertiser() {
    return (
      <Animated.View style={[
        ...
        <TouchableWithoutFeedback
          onPress={this.methods.onVisitAdvertiser} style={styles.ad.adAlignRight}>
          <View>
            <Text style={styles.ad.visitAdvertiserText}>Visit advertiser</Text>
          </View>
        </TouchableWithoutFeedback>
      </Animated.View>
    );
