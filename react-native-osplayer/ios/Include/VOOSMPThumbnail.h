...
@protocol VOOSMPThumbnail <NSObject>

/**
 * Thumbnail data(JPEG)
 *
 */
@property (nonatomic, retain, getter=getThumbnailData)NSData *thumbnailData;

/**
 * Thumbnail data size
 *
 */
@property (nonatomic, assign, getter=getDataSize)int dataSize;
 ...
 *
 */
@property (nonatomic, assign, getter=getTimestamp)int timestamp;
