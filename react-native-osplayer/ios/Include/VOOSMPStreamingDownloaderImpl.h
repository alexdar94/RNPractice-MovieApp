...
EXPORT_API
@interface VOOSMPStreamingDownloaderImpl : NSObject<VOOSMPStreamingDownloader>
{
@private
...
@interface VOOSMPStreamingDownloaderProgressInfoImpl : NSObject<VOOSMPStreamingDownloaderProgressInfo>
{
